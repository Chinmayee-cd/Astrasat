...
class FullScreenRoll extends Component {
  modalRef = null;
  btnRef = null;
  modalState = "";
  action = "";
  ...
  componentDidMount() {
    document.getElementById("modalRoll").style.display = "none";
    const modal = this.modalRef.current;
    document.getElementById("myModalRoll").style.display = "none";
  ...
  render() {
    ...
    return (
      <>
        <div id="modalRoll" style={modalback}>
          <div id="myModalRoll" style={modal}>
...
class SummaryRoll extends Component {
  modalRef = null;
  btnRef = null;
  modalState = "";
  action = "";
  ...
  componentDidMount() {
    ...
    d3.csv(data, (d) => ({
      ...
      const yScale = d3
        .scaleLinear()
        .domain([0, d3.max(dataset, (d) => d.roll)])
        .range([height, 0]);
  ...
  render() {
    ...
    return (
      <>
        <div id="modalR" style={modalback}>
          <div id="myModalR" style={modal}>
            <div class="modalContainer" style={{ padding: "-10px" }}>
              <div
                style={{
                  "text-align": "right",
...
export { SummaryRoll, FullScreenRoll };
