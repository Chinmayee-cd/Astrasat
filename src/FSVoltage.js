...
export default class FullScreenVoltage extends Component {
  modalRef = null;
  btnRef = null;
  modalState = "";
  action = "";
  ...
  componentDidMount() {
    document.getElementById("modalVoltage").style.display = "none";
    const modal = this.modalRef.current;
    document.getElementById("myModalVoltage").style.display = "none";
  ...
  render() {
    ...
    return (
      <>
        <div id="modalVoltage" style={modalback}>
          <div id="myModalVoltage" style={modal}>
