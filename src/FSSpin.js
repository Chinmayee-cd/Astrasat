...
class FullScreenSpin extends Component {
  modalRef = null;
  btnRef = null;
  modalState = "";
  action = "";
  ...
  render() {
    ...
    return (
      <>
        <div id="modalSpin" style={modalback}>
          <div id="myModalSpin" style={modal}>
...
class SummarySpin extends Component {
  modalRef = null;
  btnRef = null;
  modalState = "";
  action = "";
  ...
  componentDidMount() {
    ...
    d3.csv(data, (d) => ({
      ...
      const yScale = d3
        .scaleLinear()
        .domain([0, d3.max(dataset, (d) => d.spin)])
        .range([height, 0]);
  ...
  render() {
    ...
    return (
      <>
        <div id="modalS" style={modalback}>
          <div id="myModalS" style={modal}>
            <div class="modalContainer" style={{ padding: "-10px" }}>
              <div
                style={{
                  "text-align": "right",
...
export { SummarySpin, FullScreenSpin };
