...
class FullScreenPitch extends Component {
  modalRef = null;
  btnRef = null;
  modalState = "";
  action = "";
  ...
  componentDidMount() {
    document.getElementById("modalPitch").style.display = "none";
    const modal = this.modalRef.current;
    document.getElementById("myModalPitch").style.display = "none";
  ...
  render() {
    ...
    return (
      <>
        <div id="modalPitch" style={modalback}>
          <div id="myModalPitch" style={modal}>
...
class SummaryPitch extends Component {
  modalRef = null;
  btnRef = null;
  modalState = "";
  action = "";
  ...
  componentDidMount() {
    ...
    d3.csv(data, (d) => ({
      ...
      const yScale = d3
        .scaleLinear()
        .domain([0, d3.max(dataset, (d) => d.pitch)])
        .range([height, 0]);
  ...
  render() {
    ...
    return (
      <>
        <div id="modalP" style={modalback}>
          <div id="myModalP" style={modal}>
            <div class="modalContainer" style={{ padding: "-10px" }}>
              <div
                style={{
                  "text-align": "right",
...
export { SummaryPitch, FullScreenPitch };
